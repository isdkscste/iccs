...
<div style="display: block;" id="view1">
 <div class="form-group">
  ...
  I 
    <label id="my_declaration"  >&nbsp;&nbsp;<i><u></u></i></label>&nbsp;&nbsp;&nbsp;&nbsp; do hereby declare that  the information furnished in this form is true,complete and correct to the best of my knowledge and belief.If,at any  stage,they are found misleading or untrue,my candidature or appointment to the post may be rejected/cancelled.   </label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\iccs\resources\views/admin/view_scientist.blade.php ENDPATH**/ ?>