       ...
       <header>
           <div class="container">
               <div class="row">
                   ...
                   <div class="col-md-12">
                       <img src="<?php echo e(asset('images/ICCSn.png')); ?>" style="width: 120px;height:120px; " ><strong class="strong1" > KSCSTE-INSTITUTE FOR CLIMATE CHANGE STUDIES (ICCS)</strong>
                       <img src="<?php echo e(asset('images/k3.jpg')); ?>" style=" " alt="">
                  ...
                  <div class="row">
                      <div class="col-lg-7 col-md-6">
                           ...
                           KSCSTE-ICCS  invites application for the post of  Scientists, Applicants are requested to read the Notification, Terms and Conditions, Guideline documents from the links below.
                                ...
                                <ul>
                                 <li><a style="color:blue" target="_blank" href="<?php echo e(asset('downloads/ICCS_Notification_8nov22.pdf')); ?>"><i class="fas fa-check"></i> Notification</a>
                                 <img src="<?php echo e(asset('downloads/pdf.gif')); ?>"  style="color:blue;height:2
                                40px;width:40px"></li>
                                 <li><a style="color:blue" target="_blank" href="<?php echo e(asset('downloads/ICCS_TC_8nov22.pdf')); ?>"><i class="fas fa-check"></i> Terms and Condition</a>
                                 <img src="<?php echo e(asset('downloads/pdf.gif')); ?>"  style="color:blue;height:2
                                40px;width:40px"></li> 
                                  <li><a style="color:blue" target="_blank" href="<?php echo e(asset('downloads/ICCS_Guidelines_8nov22.pdf')); ?>"><i class="fas fa-check"></i> Guidelines for Online Application</a>
                                  <img src="<?php echo e(asset('downloads/pdf.gif')); ?>"  style="color:blue;height:2
                                40px;width:40px"></li>
...
</html><?php /**PATH F:\xampp\htdocs\iccs\resources\views/auth/login.blade.php ENDPATH**/ ?>